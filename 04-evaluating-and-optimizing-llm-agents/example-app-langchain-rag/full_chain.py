...
def create_full_chain(retriever, openai_api_key=None, chat_memory=ChatMessageHistory()):
    ...
    Use the following context about the user's meal plan to help answer their question.
    You may apply general nutritional knowledge to interpret the meals listed in the context.
    If the question is completely unrelated to health, nutrition, or the meal plan, politely redirect.
